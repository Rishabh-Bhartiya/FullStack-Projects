...
function Footer() {
    return (
        <footer className='flex flex-col sm:flex-row items-center justify-between gap-4 py-0.5 px-4 md:px-28 mt-20 text-gray-400 bg-black border-t border-zinc-800'>
